...
public class Distraction_pizza {
    ...
    public Distraction_pizza(Context context, int screenX, int screenY) {
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.pizza);//Getting image from drawable folder
        //Set values
        maxX = screenX;
        maxY = screenY;
        minX = 0;
