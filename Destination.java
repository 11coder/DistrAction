...
public class Destination {
    ...
    public Destination(Context context, int screenX, int screenY) {
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.eighth1);//Getting image from drawable folder
       //Set values
        maxX = screenX;
        maxY = screenY;
        minX = 0;
