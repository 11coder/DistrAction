...
public class Distraction_od {
    ...
    public Distraction_od(Context context, int screenX, int screenY) {
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.od);//Getting image from drawable folder
        //Set values
        maxX = screenX;
        maxY = screenY;
        minX = 0;
